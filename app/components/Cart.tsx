  ...
  return (
    <div className="drawer drawer-end indicator">
      ...
      <div className="drawer-content">
        ...
        <label
          htmlFor="my-drawer-4"
          className="drawer-button btn btn-primary z-10"
        >
          <Image
            src={cartImage}
            height={20}
              ...
              <li key={key}>
                <a className="flex items-center gap-2">
                  ...
                  <Image
                    ...
                    alt="delete item"
                    src={close}
                    className="min-h-4 min-w-4 max-h-8 max-w-8 scale-50"
                  ></Image>
                </a>
              </li>
            );
          ...
          {cartQuantity > 0 && (
            <>
              <span className="flex items-center gap-1">
                <input
                  onChange={setIsExpressShipping}
                  type="checkbox"
                  className="checkbox checkbox-xs"
                />
                <p>
                  {
                    "Express Delivery (2-3 day delivery: $15 more than Standard Delivery)"
                  }
                </p>
              </span>
              <p className="mt-4">
                {
                  "Set shipping prices apply only to orders under 2 lbs in the Continental US. For International purchases contact us (209) 492-0114."
                }
              </p>
            </>
          )}
