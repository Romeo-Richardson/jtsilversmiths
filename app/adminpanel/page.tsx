...
const page = () => {
    ...
    useEffect(() => {
        if (isSignedIn) {
            console.log(user.id)
            if (!(user.id === "user_3C2V9rtJsMvQJUiufTNdnd6bSpf" || user.id === "user_2yCOu54baLL57crreJsy8nxRKra")) {
                signOut()
            }
        }
    }, [user])
